...
`;t.Z=e=>{let{text:t,maxCharacters:n=20,margin:o=!1,adjustSize:a=!1,fontSize:d,color:c,link:h,...x}=e,{targetRef:u,tooltip:m,tooltipVisible:f}=(0,l.lL)((0,i.jsx)(r.xvT,{children:t}),{placement:"right-end",trigger:"click"});return t?t.length>n?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(s,{margin:o,adjustSize:a,link:!!h,color:c,fontSize:d,...x,ref:u,children:` ${t.slice(0,n-1)}...`}),f&&m]}):(0,i.jsx)(s,{color:c,margin:o,adjustSize:a,link:!!h,fontSize:d,...x,children:t}):(0,i.jsx)("span",{})}},42278:function(e,t,n){n.d(t,{Z:function(){return Percent}});var i=n(85893),r=n(31258),l=n(19521);let o=(0,l.ZP)(r.xvT).withConfig({componentId:"sc-9aa7bb34-0"})`

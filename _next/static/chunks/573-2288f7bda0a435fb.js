...
`,d=(0,o.ZP)(l.xuv).attrs({as:"button"}).withConfig({componentId:"sc-532dd31b-2"})`
  ...
  box-shadow: none;
`;d.defaultProps={p:"16px"};let TabToggleGroup=e=>{let{children:i}=e;return(0,n.jsx)(r,{p:["0 4px","0 16px"],children:(0,n.jsx)(s,{children:i})})}},14714:function(e,i,t){t.r(i);var n=t(85893),l=t(87619),o=t(27484),r=t.n(o),s=t(70178),d=t.n(s),c=t(94203),a=t(62810);t(67294);var x=t(9253),u=t(46888),h=t(3023),p=t(14888),v=t(86108),m=t(19521),j=t(13256),f=t(39511);r().extend(d());let g=(0,m.ZP)(l.Zbd).withConfig({componentId:"sc-361fcbfd-0"})`
